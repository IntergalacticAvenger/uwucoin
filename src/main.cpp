...
#if defined(NDEBUG)
# error "Uwucoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5e24d2858045ddc48a8e8801319ebc27d94efa27cc46c1b1cd65f13493b7b655");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Uwucoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Uwucoin Signed Message:\n";
...
{
    // Uwucoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Uwucoin: 2 days
static const int64 nTargetSpacing = 2 * 60; // Uwucoin: 2 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Uwucoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Uwucoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        pchMessageStart[0] = 0xf3; //Peer Magic changes
        pchMessageStart[1] = 0xc2;
        pchMessageStart[2] = 0xb6;
        pchMessageStart[3] = 0xd1;
        hashGenesisBlock = uint256("0x4fa19d9b63ef3650619f36594730246252e19ff7daa0f7306f8cf9a2fbd3eba1");
    }
...
//old genesis public 040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9
        ...
        block.nVersion = 1;
        block.nTime    = 1613249352;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084868288;
	//genesis block epoch times (seconds passed between now and Jan 1, 1970)
        if (fTestNet)
        {
            block.nTime    = 1613249314; //testnet time
            block.nNonce   = 385545262;
        }
//do we search for genesis block at all, if Gen hash is NOT good -> go mine  
// if genesis block is good -> ignore
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x32a0705ab026f8befdabf61b88fdd951ef0b3d6e6c199be202b0901bb0fb890c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc2, 0xbd, 0xd4 }; // Uwucoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UwucoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UwucoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static UwucoinMiner(CWallet *pwallet)
{
    printf("UwucoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("uwucoin-miner");
    ...
    try { loop {
        ...
        printf("Running UwucoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("UwucoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&UwucoinMiner, pwallet));
}
